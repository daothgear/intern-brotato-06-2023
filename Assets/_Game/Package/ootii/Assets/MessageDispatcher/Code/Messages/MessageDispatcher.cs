...
#pragma warning restore 0414
        ...
        public static Dictionary<string, Dictionary<string, MessageHandler>> MessageHandlers
        {
        ...
        public static void SendMessage(IMessage rMessage, bool rSetUnhandledToHandled = false)
        {
            ...
            else if (mMessageHandlers.ContainsKey(rMessage.Type))
            {
                ...
                Dictionary<string, MessageHandler>.Enumerator lEnumerator = lHandlers.GetEnumerator();
                while (lEnumerator.MoveNext())
                {
                    string lFilter = lEnumerator.Current.Key;
